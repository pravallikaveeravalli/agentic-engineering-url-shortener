...
- [ ] T082a [US3] Run creation and requirement submission surface — `src/main/java/agentic/shortener/orchestration/api/RunSubmissionController.java`
...
- [ ] T132 [US3] DS-A executed run — no artificial clarification gate — `docs/evidence/ds-a/run.json`
  - **Req**: **DS-A**, FR-ORC-010, FR-ORC-012 · **Scn**: **DS-A** · **ADR**: ADR-004 · **Pre**: T131, T131a
  - **Deps**: T131, T131a · **Par**: no · **Artifact**: path S1→S2→S3→**S4 `SKIPPED`**→S5→S6→S7 fan-out→S8→S9∥S10→S11→S12, terminal `COMPLETED`
