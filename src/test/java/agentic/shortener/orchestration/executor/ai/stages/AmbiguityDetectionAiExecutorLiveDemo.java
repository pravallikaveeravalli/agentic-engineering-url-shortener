...
/**
 * T073b's ONE recorded live demo run (Ruling 2, AS-007). See {@link NormalizationAiExecutorLiveDemo}'s
 * javadoc for why this class is not named {@code *Test}/{@code *IT}, and how to run it explicitly.
 */
class AmbiguityDetectionAiExecutorLiveDemo {
    ...
    void oneRealCallThroughTheRealChain() throws Exception {
        ...
        var executor = new AmbiguityDetectionAiExecutor(recording);

        StageInput input = new StageInput(UUID.randomUUID(), "S3", 3, 1,
                Map.of(AmbiguityDetectionAiExecutor.INPUT_KEY,
        ...
        System.out.println("AS-007 DEMO T073b AmbiguityDetectionAiExecutor — actually-used model id: "
                + modelId);
        System.out.println("AS-007 DEMO T073b AmbiguityDetectionAiExecutor — produced artifact: "
